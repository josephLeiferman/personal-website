...
function MagneticSocialLink({
  ...
  return (
    <Magnetic springOptions={{ bounce: 0 }} intensity={0.3}>
      <a
        href={link}
        className="group relative inline-flex shrink-0 items-center gap-[1px] rounded-full bg-zinc-100 px-2.5 py-1 text-sm text-black transition-colors duration-200 hover:bg-blue-500 hover:text-zinc-50 dark:bg-zinc-800 dark:text-zinc-100 dark:hover:bg-zinc-700"
      >
        {children}
        <svg
          width="15"
      ...
      >
        <div className="flex-1">
          <p className="text-zinc-700 dark:text-zinc-300">
            ...
            Throughout my journey I have collaborated with diverse teams, and I am continuously learning and growing in this ever-evolving field.
            Browse through my work history and side projects, and if you like what you see
            let's connect and explore the possibilities of creating exceptional software together.
          </p>
        </div>
      </motion.section>
