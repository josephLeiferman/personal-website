...
export default function LayoutBlogPost({
  ...
  return (
    <>
      ...
      <ScrollProgress
        className="fixed top-0 z-20 h-0.5 bg-blue-600 dark:bg-blue-500"
